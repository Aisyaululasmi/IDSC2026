...
\graphicspath{{./reports/}}   % figures live in reports/
...
\begin{figure}[H]
  \centering
  \subfloat[V1+V2 (2-lead)]{\includegraphics[width=0.48\columnwidth]{v1v2/training_curves.png}}
  \hfill
  \subfloat[V1+V2+V3 (3-lead)]{\includegraphics[width=0.48\columnwidth]{v1v2v3/training_curves.png}}
